...
import { idlFactory } from './flood_data_storage.did.js';
export { idlFactory } from './flood_data_storage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FLOOD_DATA_STORAGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./flood_data_storage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the flood_data_storage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./flood_data_storage.did.js")._SERVICE>}
 */
export const flood_data_storage = createActor(canisterId);
