...
export { idlFactory } from './paramify_insurance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PARAMIFY_INSURANCE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./paramify_insurance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the paramify_insurance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./paramify_insurance.did.js")._SERVICE>}
 */
export const paramify_insurance = createActor(canisterId);
